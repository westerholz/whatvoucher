...
import com.whatvoucher.backend.data.Availability;
import com.whatvoucher.backend.data.Category;
import com.whatvoucher.backend.data.Product;
...
public class ProductForm extends Div {
    ...
    public ProductForm(SampleCrudLogic sampleCrudLogic) {
        ...
        productName = new TextField("Voucher name");
